...
vim.keymap.set("n", "<leader>xx", function()
  ...
  local items = require("fredrik.utils.diagnostics").diagnostics_to_qf_items(diagnostics)
  vim.fn.setloclist(0, items)
  vim.cmd("lopen")
end, { desc = "Buffer diagnostics to location list", silent = true })
vim.keymap.set("n", "<leader>xX", function()
  local diagnostics = vim.diagnostic.get()
  local items = require("fredrik.utils.diagnostics").diagnostics_to_qf_items(diagnostics)
  vim.fn.setqflist(items)
  vim.cmd("copen")
end, { desc = "Workspace diagnostics to quickfix list", silent = true })
