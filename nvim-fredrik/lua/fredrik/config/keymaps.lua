...
vim.keymap.set("n", "<leader>uc", function()
  require("fredrik.utils.toggle").toggle_copilot({ manual = true })
...
function M.setup_dap_ui_keymaps()
  -- keymaps: https://codeberg.org/mfussenegger/nvim-dap/blob/master/doc/dap.txt#L508
  ...
  return {
    {
      "<leader>ns",
      function()
        Snacks.picker.grep({ cwd = obsidian_vars.vault_path })
      end,
      desc = "[N]otes: [s]earch text",
    },
    ...
    { "<leader>nt", "<cmd>Obsidian new_from_template<cr>", desc = "[N]otes: new from [t]emplate" },
    {
      "<leader>nS",
      function()
