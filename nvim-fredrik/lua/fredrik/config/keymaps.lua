...
vim.keymap.set("n", "<leader>xx", function()
  require("fredrik.utils.quickfix").open_loclist()
end, { desc = "Buffer diagnostics to location list (auto-update)", silent = true })
vim.keymap.set("n", "<leader>xX", function()
  require("fredrik.utils.quickfix").open_qflist()
end, { desc = "Workspace diagnostics to quickfix list (auto-update)", silent = true })
