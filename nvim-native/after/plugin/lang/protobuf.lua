-- Protobuf: formatters, linters (protolint, buf_lint, api_linter).
...
require("lint").linters_by_ft.proto = { "protolint" }

local protolint_config_file = vim.env.DOTFILES .. "/extras/templates/.protolint.yaml"
require("lint").linters.protolint = vim.tbl_deep_extend("force", require("lint").linters.protolint or {}, {
